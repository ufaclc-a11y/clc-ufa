        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pb-16 w-full">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#C94700] text-white font-semibold px-6 py-3.5 rounded-full hover:bg-[#B13E00] transition-colors shadow-[0_4px_20px_rgba(141,50,0,0.24)]"
            >
