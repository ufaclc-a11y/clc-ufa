...
const categoryMeta: Record<string, { title: string; description: string }> = {
  ...
  'toppery':             { title: 'Топперы на торт из акрила и фанеры — Уфа',      description: 'Топперы на торт из акрила и фанеры — имена, даты, надписи. Лазерная резка в Уфе, от 1 штуки, срок от 1 дня.' },
