  ...
  return (
    <header id="new-home-hero" className="relative isolate min-h-[720px] bg-[#0D2A80] pt-20 text-white sm:min-h-[760px] sm:pt-24 lg:min-h-[820px]">
      <Image
        ...
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-[#07194b]/60 lg:bg-[#07194b]/40" aria-hidden="true" />
      <div className="absolute inset-y-0 left-0 hidden w-[58%] bg-[#07194b]/75 lg:block" aria-hidden="true" />
