      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex justify-between">
        ...
        <div className="hidden xl:flex items-center gap-2 shrink-0">
          ...
          <a href={business.whatsapp} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
            className="w-11 h-11 flex items-center justify-center rounded-full bg-[#25D366] hover:bg-[#1fb855] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 focus-visible:ring-offset-[#111] shrink-0">
          ...
          <a href={business.telegram} target="_blank" rel="noopener noreferrer" aria-label="Telegram"
            className="w-11 h-11 flex items-center justify-center rounded-full bg-[#2AABEE] hover:bg-[#1a9adc] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2AABEE] focus-visible:ring-offset-2 focus-visible:ring-offset-[#111] shrink-0">
          ...
          <a href={business.max} target="_blank" rel="noopener noreferrer" aria-label="MAX"
            className="w-11 h-11 flex items-center justify-center rounded-full bg-gradient-to-br from-[#2B7FFF] to-[#9B3FE8] hover:brightness-110 transition-[filter] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#9B3FE8] focus-visible:ring-offset-2 focus-visible:ring-offset-[#111] shrink-0">
        ...
        <div className="xl:hidden flex items-center gap-2 shrink-0">
          <CartButton className="h-11 w-11 px-0" />
          <SiteSearch />
          <button
            ref={menuButtonRef}
            type="button"
            ...
            className="w-11 h-11 flex flex-col items-center justify-center gap-[5px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B00] rounded-lg"
          >
            <span aria-hidden="true" className={`w-5 h-[2px] bg-white block transition-transform duration-200 origin-center ${open ? 'rotate-45 translate-y-[7px]' : ''}`} />
            <span aria-hidden="true" className={`w-5 h-[2px] bg-white block transition-opacity duration-200 ${open ? 'opacity-0' : ''}`} />
            <span aria-hidden="true" className={`w-5 h-[2px] bg-white block transition-transform duration-200 origin-center ${open ? '-rotate-45 -translate-y-[7px]' : ''}`} />
          </button>
        </div>
      </div>
      ...
      {open && <div id="mobile-navigation" className="border-t border-white/10 bg-[#111] xl:hidden">
        <div className="px-4 py-6 flex flex-col gap-5">
          ...
          <div className="border-t border-white/10 pt-5 flex flex-col gap-3">
            <a href={`tel:${business.phone}`} className="flex min-h-11 items-center font-mono text-sm text-white/75 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B00] rounded">
              {business.phoneDisplay}
            </a>
