  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#E7E8EE] bg-white text-[#17181B] shadow-[0_8px_28px_rgba(39,32,56,0.06)]">
      <div className="hidden border-b border-[#EFF0F4] bg-[#FAFAFC] md:block">
        <div className="mx-auto flex h-9 max-w-[1480px] items-center justify-between px-6 text-xs text-[#62646D]">
          ...
          <div className="flex items-center gap-5">
            <Link className="rounded hover:text-[#17181B] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B00]" href="/about">О компании</Link>
            <Link className="rounded hover:text-[#17181B] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B00]" href="/contacts">Контакты</Link>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto flex h-[66px] max-w-[1480px] items-center gap-3 px-4 sm:h-[74px] sm:gap-4 sm:px-6">
        ...
        >
          <span className="text-[28px] font-extrabold leading-none tracking-[-0.04em] text-[#FF5A00] sm:text-[34px]">CLC</span>
          <span className="hidden max-w-[104px] text-[9px] font-extrabold uppercase leading-[1.15] tracking-[0.08em] text-[#24252A] lg:block">
